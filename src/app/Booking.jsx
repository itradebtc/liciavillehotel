  ...
  return (
    <div className='py-2 md:py-0 bg-[url(./images/contact.png)] bg-center bg-contain items-center'>
        <div className='space-y-3 px-3 md:py-9 md:px-36 md:mx-36 md:space-y-7'>
            <h3 className={`${mod.className} text-3xl md:text-7xl text-center text-yellow-600`}>Reservation Booking</h3>
            <div className='w-full md:w-[40vw] bg-transparent border-hidden md:border-solid border-4 border-yellow-600 rounded-md md:mx-36'>
                <form ref={form} onSubmit={sendmail} className='space-y-4 py-4 px-8'>
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Full Name <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Email <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Phone <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Check In <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Check Out <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col'>
                      <label className='py-2 text-yellow-600 text-lg'>Rooms <span className='text-red-900 text-sm'>*</span></label>
                    ...
                    <div className='flex flex-col u-form-group u-form-message space-y-2 mb-3'>
                      <label className='text-yellow-600 text-lg'>Special Requests?</label>
