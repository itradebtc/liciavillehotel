...
import pic from '../images/exclusive.jpg'
  ...
  return (
    <div className='md:flex gap-7 border-4 border-slate-300 rounded-b-xl md:m-auto '>
      ...
      <div className='flex flex-col text-black space-y-4 md:p-7'>
        ...
        <p>The modern and light interior provides you with a comfortable atmosphere and each Superior Room contains complementary toiletries, deluxe bath towels, cosy bedding.</p>
      </div>
    </div>
  )
}
