...
export const NavBar = () => {
  ...
  return (
    <nav className='shadow-2xl'>
        <div className='flex justify-between items-center bg-blue-800 py-2 px-7 md:py-3 md:px-16'>
        ...
        <div className='flex justify-between items-center px-7 md:py-3 md:px-16 2xl:px-16 bg-slate-50'>
            ...
            <div className='hidden sm:flex'>
                <ul className='hidden sm:flex justify-center items-center text-slate-600'>
                    ...
                    <li className='ml-10 uppercase hover:ease-in duration-300 hover:scale-110 hover:text-yellow-600 text-lg'>About Us</li>
                    <Link href='./contact'>
