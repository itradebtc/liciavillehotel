        ...
        export default async function Rooms() {
            ...
            const list = myRoom.rooms.map(rooms =>(
              <section key={rooms.id} className='py-12 px-20'>
                  ...
                  <Image src={rooms.photo} alt='rooms' width="600" height="300" className='rotate-90 border-2 w-full md:w-[70vw] py-7'/>
          ...
          return (
            <div className='pb-12'>
                <div className='grid md:grid-cols-4 gap-2 justify-center items-center text-black hover:ease-in duration-300'>
                    {list}
                </div>
            </div>
          )
